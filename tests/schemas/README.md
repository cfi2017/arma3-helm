`udproute_v1.json` is the OpenAPI validation schema extracted without modification from the stable `v1` version of:

https://github.com/kubernetes-sigs/gateway-api/blob/v1.6.0/config/crd/standard/gateway.networking.k8s.io_udproutes.yaml
